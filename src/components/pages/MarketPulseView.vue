<template>
    <div class="flex flex-col h-full bg-slate-950 p-5 gap-5">
    ...
    <!-- Chart Container -->
    <div class="flex-1 min-h-0 bg-slate-900 rounded-sm border border-slate-800 overflow-hidden shadow-2xl relative flex flex-col">
...
const indicators = ref([
  ...
  { id: 'bb', label: 'BB', active: false, color: '#ec4899', type: 'overlay', name: 'Bollinger Bands' },
